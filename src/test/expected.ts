...
export const missingNamePlaceholderButtons = {
  error: {
    message: '(#100) param name_placeholder[buttons] must be non-empty.',
    type: 'OAuthException',
    code: 100,
    fbtrace_id: 'BfxA93\/c3oO',
  },
};
export const missingElementButtonTitle = {
  error: {
...
export const missingPostbackTypeButtonPayload = {
  error: {
...
export const missingUrlTypeButtonUrl = {
  error: {
